...
【🚫 화투패·고스톱 금지】
초등학생 대상 학습 환경이므로, 게임 화면·아이콘·이모지 어디에도 **화투(고스톱) 이미지를 절대 사용하지 않습니다**.
- ❌ 금지 이모지: 🎴 (flower playing cards / 화투패), 🀄 (mahjong red dragon)
- ❌ 금지 시각 요소: 화투패 패턴, 솔·매조·흑싸리·홍단·청단·열끗·피 등 화투 의장
- ❌ 금지 명칭: "고스톱", "화투", "패 뽑기" 등 도박성 연상 단어
- ✅ "황금카드"·"이벤트 칸"·"황금키" 등은 🔑 (열쇠) / 🎁 (선물) / ✨ (반짝임) / 💰 (금화) 같은 안전한 이모지로 표현합니다.
- 학생 문서에 🎴 가 들어있더라도 무시하고 🔑 로 대체해 그립니다.
